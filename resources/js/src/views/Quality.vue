...
export default {
    ...
    methods: {
      getRegisters(page = 1,url = '/api/qualitys/?page=') {
        this.tableData.draw++;
      ...
      getColumns(){
        axios.post('/api/config/columns/qualitys',{id:1})
          .then(response => {
      ...
      save(formfields,modalname){        
        ...
        if(formfields.id){
          ...
          axios.post('/api/qualitys/edit', values)
          .then(response => {
            this.snackbar = true
          ...
          axios.post('/api/qualitys/save', values)
          .then(response => {  
            this.snackbar = true
            this.toastText = response.data.message
            console.log(response)
      ...
      saveBulk(formfields,modalname){  
        ...
        axios.post('/api/qualitys/edit/multiple', bodyFormData, {
          headers: {
      ...
      changestatus(status,id){
        status = status? 1:0
        axios.get('/api/qualitys/status/'+id+'/'+status)
          .then(response => {
            this.snackbar = true
            this.toastText = response.data.message
            console.log(response)
      ...
      trash(id){
        axios.get('/api/qualitys/trash/'+id)
          .then(response => {
            this.snackbar = true
            this.toastText = response.data.message
            console.log(response)
      ...
      deleteregister(id){
        axios.get('/api/qualitys/delete/'+id)
          .then(response => {
            this.snackbar = true
            this.toastText = response.data.message
            console.log(response)
      ...
      onFileChanged(e) {
        ...
        axios.post('/api/qualitys/import', formData)
          .then(response => {
            this.snackbar = true
            this.toastText = response.data.message
            console.log(response)
      ...
      exportRegisters(){
        ...
        axios.post('/api/qualitys/export',{responseType: 'arraybuffer'})
          .then(response => {
                var fileURL = window.URL.createObjectURL(new Blob([response.data]));
                var fileLink = document.createElement('a');
                fileLink.href = fileURL;
                fileLink.setAttribute('download', 'qualitys.csv');
      ...
      exportTemplate(){
        ...
        axios.post('/api/qualitys/export/template',{responseType: 'arraybuffer'})
          .then(response => {
                var fileURL = window.URL.createObjectURL(new Blob([response.data]));
                var fileLink = document.createElement('a');
                fileLink.href = fileURL;
                fileLink.setAttribute('download', 'qualitystemplate.csv');
                document.body.appendChild(fileLink);
                fileLink.click();
      ...
      getTrash(){
        axios.post('api/qualitys/gettrash/')
          .then(response => {
      ...
      trashBulkRegister(){
        ...
        var bodyFormData = new FormData()
        bodyFormData.append('ids', this.selectedIds); 
        axios.post('/api/qualitys/trash/multiple', bodyFormData, {
            headers: {
                'Content-Type': 'multipart/form-data'
            }
        })
      ...
      deleteBulkRegister(){
        ...
        var bodyFormData = new FormData()
        bodyFormData.append('ids', this.selectedIds); 
        axios.post('/api/qualitys/delete/multiple', bodyFormData, {
            headers: {
                'Content-Type': 'multipart/form-data'
            }
        })
