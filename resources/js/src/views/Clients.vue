...
export default {
    ...
    methods: {
      getRegisters(page = 1,url = '/api/clients/?page=') {
        this.tableData.draw++;
      ...
      getColumns(){
        axios.post('/api/config/columns/clients',{id:1})
          .then(response => {
      ...
      save(formfields,modalname){        
        ...
        if(formfields.id){
          ...
          axios.post('/api/clients/edit', values)
          .then(response => {
            this.snackbar = true
          ...
          axios.post('/api/clients/save', values)
          .then(response => {  
            this.snackbar = true
            this.toastText = response.data.message
            console.log(response)
      ...
      saveBulk(formfields,modalname){  
        ...
        axios.post('/api/clients/edit/multiple', bodyFormData, {
          headers: {
      ...
      changestatus(status,id){
        status = status? 1:0
        axios.get('/api/clients/status/'+id+'/'+status)
          .then(response => {
            this.snackbar = true
            this.toastText = response.data.message
            console.log(response)
      ...
      trash(id){
        axios.get('/api/clients/trash/'+id)
          .then(response => {
            this.snackbar = true
            this.toastText = response.data.message
            console.log(response)
      ...
      deleteregister(id){
        axios.get('/api/clients/delete/'+id)
          .then(response => {
            this.snackbar = true
            this.toastText = response.data.message
            console.log(response)
      ...
      exportRegisters(){
        ...
        axios.post('/api/clients/export',{responseType: 'arraybuffer'})
          .then(response => {
      ...
      exportTemplate(){
        ...
        axios.post('/api/clients/export/template',{responseType: 'arraybuffer'})
          .then(response => {
                var fileURL = window.URL.createObjectURL(new Blob([response.data]));
                var fileLink = document.createElement('a');
                fileLink.href = fileURL;
                fileLink.setAttribute('download', 'clientstemplate.csv');
                document.body.appendChild(fileLink);
                fileLink.click();
      ...
      getTrash(){
        axios.post('api/clients/gettrash/')
          .then(response => {
      ...
      trashBulkRegister(){
        ...
        var bodyFormData = new FormData()
        bodyFormData.append('ids', this.selectedIds); 
        axios.post('/api/clients/trash/multiple', bodyFormData, {
            headers: {
                'Content-Type': 'multipart/form-data'
            }
        })
      ...
      deleteBulkRegister(){
        ...
        var bodyFormData = new FormData()
        bodyFormData.append('ids', this.selectedIds); 
        axios.post('/api/clients/delete/multiple', bodyFormData, {
            headers: {
                'Content-Type': 'multipart/form-data'
            }
        })
